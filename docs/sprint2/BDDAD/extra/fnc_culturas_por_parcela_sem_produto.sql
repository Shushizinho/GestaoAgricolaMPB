create or replace NONEDITIONABLE FUNCTION fnc_culturas_por_parcela_sem_parcela(p_nome_parcela ParcelaAgricola.designacao%TYPE, p_DataRealizacao OperacaoAgricola.DataRealizacao%TYPE)
